...
import 'package:judicial_exams/views/start_exam_pages/start_exam_page.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              InkWell(
                  onTap:(){
                    Get.to(() => StartExamPage(listCtrl.purchaseExamList[index]));
                  },
                  child: CustomButton().customButtonSmall(context, "Start Exam")
        )
            ],
          ),
        ),
