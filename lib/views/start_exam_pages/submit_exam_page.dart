  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Submit Answer", style: GoogleFonts.montserrat(
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Text("Submit your answer script within the given time", style: AppStyle().subheadingBlack,textAlign: TextAlign.center,),
                  ),
                  Obx(
                          ()=>Center(
                  ...
                  GestureDetector(
                      ...
                      child: CustomButton().customButtonSmall(context, "Select File")),
